#if !defined(__AVM_NET_CFG_ATHEROS_HW241_H_)
#define __AVM_NET_CFG_ATHEROS_HW241_H_
...
extern avmnet_module_t hw241_gmac0, hw241_module_eth0;

avmnet_device_t avmnet_hw241_avm_device_0 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
...
avmnet_device_t *avmnet_hw241_avm_devices[] = {
    &avmnet_hw241_avm_device_0,
}; 

avmnet_module_t avmnet_hw241 ____cacheline_aligned =
{
    .name           = "athmac",
    ...
    .parent         = NULL,
    .num_children   = 1,
    .children       = { &hw241_gmac0 }
};

avmnet_module_t hw241_gmac0 ____cacheline_aligned =
{
    .name           = "gmac0",
    .type           = avmnet_modtype_mac,
    .priv           = NULL,
    ...
    .parent         = &avmnet_hw241,
    .num_children   = 1,
    .children       = { &hw241_module_eth0 },
};

avmnet_module_t hw241_module_eth0 ____cacheline_aligned =
{
    .name           = "ar8033",
    .device_id      = &avmnet_hw241_avm_device_0,
