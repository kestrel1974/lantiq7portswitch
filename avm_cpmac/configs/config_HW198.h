#if !defined(__AVM_NET_CFG_HW198)
#define __AVM_NET_CFG_HW198
...
extern avmnet_module_t hw198_avmnet_mac_7port_1;
extern avmnet_module_t hw198_avmnet_mac_7port_2;
extern avmnet_module_t hw198_avmnet_mac_7port_3;
extern avmnet_module_t hw198_avmnet_mac_7port_4;

avmnet_device_t hw198_avmnet_avm_device_0 =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
   ...
   .mac_module        = &hw198_avmnet_mac_7port_1,
   .etht_stat         = {
                            DEFAULT_HW_STATS,
...
avmnet_device_t hw198_avmnet_avm_device_1 =
{
   .device            = NULL,
   .device_name       = "eth1",
   .external_port_no  = 1,
   ...
   .device_setup_priv = ifx_ppa_setup_priv,
   .flags		  	  = AVMNET_DEVICE_IFXPPA_ETH_LAN,
   .mac_module        = &hw198_avmnet_mac_7port_4,
   .etht_stat         = {
                            DEFAULT_HW_STATS,
                            DEFAULT_AVMNET_STATS,
                            .gather_hw_stats = create_7port_rmon_cnt,
...
avmnet_device_t hw198_avmnet_avm_device_2 =
{
   .device            = NULL,
   .device_name       = "eth2",
   .external_port_no  = 2,
   ...
   .device_setup_priv = ifx_ppa_setup_priv,
   .flags		  	  = AVMNET_DEVICE_IFXPPA_ETH_LAN,
   .mac_module        = &hw198_avmnet_mac_7port_2,
   .etht_stat         = {
                            DEFAULT_HW_STATS,
                            DEFAULT_AVMNET_STATS,
                            .gather_hw_stats = create_7port_rmon_cnt,
...
avmnet_device_t hw198_avmnet_avm_device_3 =
{
   .device            = NULL,
   .device_name       = "eth3",
   .external_port_no  = 3,
   ...
   .device_setup_priv = ifx_ppa_setup_priv,
   .flags		  	  = AVMNET_DEVICE_IFXPPA_ETH_LAN,
   .mac_module        = &hw198_avmnet_mac_7port_3,
   .etht_stat         = {
                            DEFAULT_HW_STATS,
                            DEFAULT_AVMNET_STATS,
                            .gather_hw_stats = create_7port_rmon_cnt,
...
avmnet_device_t hw198_avmnet_avm_device_4 =
{
   .device            = NULL,
   .device_name       = "ptm_vr9",
...
avmnet_device_t *hw198_avmnet_avm_devices[] = {
    &hw198_avmnet_avm_device_0,
    &hw198_avmnet_avm_device_1,
    &hw198_avmnet_avm_device_2,
    &hw198_avmnet_avm_device_3,
    &hw198_avmnet_avm_device_4
}; 

avmnet_module_t hw198_avmnet =
{
    .name               = "swi_vr9",
...
//                                     | AVMNET_CONFIG_FLAG_MDIOPOLLING
    ...
    .parent             = NULL,
    .num_children       = 4,
    .children           = { &hw198_avmnet_mac_7port_1,
                            &hw198_avmnet_mac_7port_2,
                            &hw198_avmnet_mac_7port_3,
                            &hw198_avmnet_mac_7port_4,
                          }
};


extern avmnet_module_t hw198_avmnet_phy_11G_0;
extern avmnet_module_t hw198_avmnet_phy_11G_1;
extern avmnet_module_t hw198_avmnet_phy_22F_2;
extern avmnet_module_t hw198_avmnet_phy_22F_3;

avmnet_module_t hw198_avmnet_mac_7port_1 =
{
    .name               = "mac_7port_1",
...
//                            .mac_mode = MAC_MODE_AUTO,
    ...
    .parent             = &hw198_avmnet,
    .num_children       = 1,
    .children           = { &hw198_avmnet_phy_11G_0 }
};

avmnet_module_t hw198_avmnet_mac_7port_4 =
{
    .name               = "mac_7port_4",
    .type               = avmnet_modtype_mac,
    .priv               = NULL,
...
//                            .mac_mode = MAC_MODE_AUTO,
    ...
    .parent             = &hw198_avmnet,
    .num_children       = 1,
    .children           = { &hw198_avmnet_phy_11G_1 }
};

avmnet_module_t hw198_avmnet_mac_7port_3 =
{
    .name               = "mac_7port_3",
    .type               = avmnet_modtype_mac,
    .priv               = NULL,
...
//                            .mac_mode =  MAC_MODE_AUTO,
    ...
    .parent             = &hw198_avmnet,
    .num_children       = 1,
    .children           = { &hw198_avmnet_phy_22F_3 }
};

avmnet_module_t hw198_avmnet_mac_7port_2 =
{
    .name               = "mac_7port_2",
    .type               = avmnet_modtype_mac,
    .priv               = NULL,
...
//                            .mac_mode =  MAC_MODE_AUTO,
    ...
    .parent             = &hw198_avmnet,
    .num_children       = 1,
    .children           = { &hw198_avmnet_phy_22F_2 }
};

avmnet_module_t hw198_avmnet_phy_11G_0 =
{
    .name               = "phy_11G_0",
    .device_id          = &hw198_avmnet_avm_device_0,
    ...
    .parent             = &hw198_avmnet_mac_7port_1,
    .num_children       = 0,
    .children           = {}
};

avmnet_module_t hw198_avmnet_phy_11G_1 =
{
    .name               = "phy_11G_1",
    .device_id          = &hw198_avmnet_avm_device_1,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
                            .flags = AVMNET_CONFIG_FLAG_PHY_GBIT |
    ...
    .parent             = &hw198_avmnet_mac_7port_4,
    .num_children       = 0,
    .children           = {}
};

avmnet_module_t hw198_avmnet_phy_22F_2 =
{
    .name               = "phy_22F_2",
    .device_id          = &hw198_avmnet_avm_device_2,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
    ...
    .parent             = &hw198_avmnet_mac_7port_2,
    .num_children       = 0,
    .children           = {}
};

avmnet_module_t hw198_avmnet_phy_22F_3 =
{
    .name               = "phy_22F_3",
    .device_id          = &hw198_avmnet_avm_device_3,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
                            .flags = AVMNET_CONFIG_FLAG_INTERNAL |
    ...
    .parent             = &hw198_avmnet_mac_7port_3,
    .num_children       = 0,
    .children           = {}
};
