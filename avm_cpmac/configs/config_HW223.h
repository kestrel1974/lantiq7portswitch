#if !defined(__AVM_NET_CFG_HW223_)
#define __AVM_NET_CFG_HW223_
...
extern avmnet_module_t hw223_avmnet_mac_7port_0;
extern avmnet_module_t hw223_avmnet_mac_7port_1;
extern avmnet_module_t hw223_avmnet_mac_7port_2;
extern avmnet_module_t hw223_avmnet_mac_7port_4;
extern avmnet_module_t hw223_avmnet_mac_7port_5;

avmnet_device_t hw223_avmnet_avm_device_0 =
{
   .device            = NULL,
   .device_name       = "wan",
   .external_port_no  = 4,
   ...
   .mac_module        = &hw223_avmnet_mac_7port_0,
   .etht_stat         = {
                            DEFAULT_HW_STATS,
...
avmnet_device_t hw223_avmnet_avm_device_1 =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
   ...
   .mac_module        = &hw223_avmnet_mac_7port_4,
   .etht_stat         = {
                            DEFAULT_HW_STATS,
                            DEFAULT_AVMNET_STATS,
                            .gather_hw_stats = create_7port_rmon_cnt,
...
avmnet_device_t hw223_avmnet_avm_device_2 =
{
   .device            = NULL,
   .device_name       = "eth1",
   .external_port_no  = 1,
   ...
   .device_setup_priv = ifx_ppa_setup_priv,
   .flags		  	  = AVMNET_DEVICE_IFXPPA_ETH_LAN,
   .mac_module        = &hw223_avmnet_mac_7port_2,
   .etht_stat         = {
                            DEFAULT_HW_STATS,
                            DEFAULT_AVMNET_STATS,
                            .gather_hw_stats = create_7port_rmon_cnt,
...
\*------------------------------------------------------------------------------------------*/
avmnet_device_t hw223_avmnet_avm_device_3 =
{
   .device            = NULL,
   .device_name       = "eth2.2",
   .external_port_no  = 2,
...
avmnet_device_t hw223_avmnet_avm_device_4 =
{
   .device            = NULL,
   .device_name       = "eth3.3",
   .external_port_no  = 3,
...
avmnet_device_t hw223_avmnet_avm_device_5 =
{
   .device            = NULL,
   .device_name       = "wasp",
   ...
   .mac_module        = &hw223_avmnet_mac_7port_5,
   .etht_stat         = {
                            DEFAULT_HW_STATS,
                            DEFAULT_AVMNET_STATS,
                            .gather_hw_stats = create_7port_rmon_cnt,
...
avmnet_device_t hw223_avmnet_avm_device_6 =
{
   .device            = NULL,
...
avmnet_device_t *hw223_avmnet_avm_devices[] = {
    &hw223_avmnet_avm_device_0,
    &hw223_avmnet_avm_device_1,
    &hw223_avmnet_avm_device_2,
    &hw223_avmnet_avm_device_3,
    &hw223_avmnet_avm_device_4,
    &hw223_avmnet_avm_device_5,
    &hw223_avmnet_avm_device_6,
}; 

avmnet_module_t hw223_avmnet =
{
    .name               = "swi_vr9",
    ...
    .num_children       = 5,
    .children           = {
                            &hw223_avmnet_mac_7port_5,
                            &hw223_avmnet_mac_7port_0,
                            &hw223_avmnet_mac_7port_1,
                            &hw223_avmnet_mac_7port_2,
                            &hw223_avmnet_mac_7port_4
                          }
};

extern avmnet_module_t hw223_avmnet_phy_fiber;
extern avmnet_module_t hw223_avmnet_phy_ar803x_0;
extern avmnet_module_t hw223_avmnet_phy_ar803x_1;
extern avmnet_module_t hw223_ath_switch;
extern avmnet_module_t hw223_avmnet_phy_11G_0;
extern avmnet_module_t hw223_avmnet_phy_11G_1;
extern avmnet_module_t hw223_avmnet_phy_wasp;
extern avmnet_module_t hw223_avmnet_dummy;

avmnet_module_t hw223_avmnet_mac_7port_0 =
{
    .name               = "mac_7port_0",
    ...
    .parent             = &hw223_avmnet,
    .num_children       = 1,
    .children           = { &hw223_avmnet_phy_fiber }
};

avmnet_module_t hw223_avmnet_mac_7port_1 =
{
    .name               = "mac_7port_1",
    .type               = avmnet_modtype_mac,
    .priv               = NULL,
    ...
    .parent             = &hw223_avmnet,
    .num_children       = 1,
    .children           = { &hw223_ath_switch }
};

avmnet_module_t hw223_avmnet_mac_7port_2 =
{
    .name               = "mac_7port_2",
    .type               = avmnet_modtype_mac,
    .priv               = NULL,
    ...
    .parent             = &hw223_avmnet,
    .num_children       = 1,
    .children           = { &hw223_avmnet_phy_11G_1 }
};

avmnet_module_t hw223_avmnet_mac_7port_4 =
{
    .name               = "mac_7port_4",
    .type               = avmnet_modtype_mac,
    .priv               = NULL,
    ...
    .parent             = &hw223_avmnet,
    .num_children       = 1,
    .children           = { &hw223_avmnet_phy_11G_0 }
};

avmnet_module_t hw223_avmnet_mac_7port_5 =
{
    .name               = "mac_7port_5",
    .type               = avmnet_modtype_mac,
    .priv               = NULL,
    ...
    .parent             = &hw223_avmnet,
    .num_children       = 1,
    .children           = { &hw223_avmnet_phy_wasp }
};

avmnet_module_t hw223_ath_switch  =
{
    .name           = "ar8334",
    .device_id      = &hw223_avmnet_avm_device_6,   /*--- das Interface zum hw223_avmnet_mac_7port_1 wird hier initialisiert ---*/
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    .initdata.swi   = { 
                        .flags = AVMNET_CONFIG_FLAG_TX_DELAY | 
    ...
    .parent         = &hw223_avmnet_mac_7port_1,
    .num_children   = 2,
    .children       = { &hw223_avmnet_phy_ar803x_0, &hw223_avmnet_phy_ar803x_1 }
};

avmnet_module_t hw223_avmnet_phy_ar803x_0 =
{
    .name               = "phy_ar803x_0",
    .device_id          = &hw223_avmnet_avm_device_3,
    ...
    .parent             = &hw223_ath_switch,
    .num_children       = 0,
    .children           = {}
};

avmnet_module_t hw223_avmnet_phy_ar803x_1 =
{
    .name               = "phy_ar803x_1",
    .device_id          = &hw223_avmnet_avm_device_4,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
                            .flags = AVMNET_CONFIG_FLAG_MDIOADDR |
...
avmnet_module_t hw223_avmnet_phy_11G_0 =
{
    .name               = "phy_11G_0",
    .device_id          = &hw223_avmnet_avm_device_1,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
                            .flags = AVMNET_CONFIG_FLAG_MDIOADDR |
    ...
    .parent             = &hw223_avmnet_mac_7port_4,
    .num_children       = 0,
    .children           = {}
};

avmnet_module_t hw223_avmnet_phy_11G_1 =
{
    .name               = "phy_11G_1",
    .device_id          = &hw223_avmnet_avm_device_2,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
                            .flags = AVMNET_CONFIG_FLAG_MDIOADDR |
    ...
    .parent             = &hw223_avmnet_mac_7port_2,
    .num_children       = 0,
    .children           = {}
};

avmnet_module_t hw223_avmnet_phy_fiber =
{
    .name               = "phy_fiber",
    .device_id          = &hw223_avmnet_avm_device_0,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
                            .flags = AVMNET_CONFIG_FLAG_MDIOADDR |
    ...
    .parent             = &hw223_avmnet_mac_7port_0,
    .num_children       = 0,
    .children           = {}
};

avmnet_module_t hw223_avmnet_phy_wasp =
{
    .name               = "phy_wasp",
    .device_id          = &hw223_avmnet_avm_device_5,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
                            .mdio_addr = 0x07,
    ...
    .parent             = &hw223_avmnet_mac_7port_5,
    .num_children       = 0,
    .children           = {}
};

#endif // __AVM_NET_CFG_HW223_
