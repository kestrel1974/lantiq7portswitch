#if !defined(__AVM_NET_CFG_ATHEROS_HW222_wlan_prod_test)
#define __AVM_NET_CFG_ATHEROS_HW222_wlan_prod_test
...
extern avmnet_module_t hw222wtest_gmac1, hw222wtest_ath_switch, hw222wtest_module_eth0;

avmnet_device_t avmnet_hw222wtest_avm_device_0 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
...
avmnet_device_t *avmnet_hw222_wlanprodtest_avm_devices[] = {
    &avmnet_hw222wtest_avm_device_0
}; 

avmnet_module_t avmnet_HW222_wlanprodtest ____cacheline_aligned =
{
    .name           = "athmac",
    ...
    .parent         = NULL,
    .num_children   = 1,
    .children       = { &hw222wtest_gmac1 }
};

avmnet_module_t hw222wtest_gmac1 ____cacheline_aligned =
{
    .name           = "gmac1",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    ...
    .parent         = &avmnet_HW222_wlanprodtest,
    .num_children   = 1,
    .children       = { &hw222wtest_ath_switch },
};

avmnet_module_t hw222wtest_ath_switch ____cacheline_aligned =
{
    .name           = "ar8326",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    ...
    .parent         = &hw222wtest_gmac1,
    .num_children   = 1,
    .children       = { &hw222wtest_module_eth0 }
};

avmnet_module_t hw222wtest_module_eth0 ____cacheline_aligned =
{
    .name           = "ar803x0",
    .device_id      = &avmnet_hw222wtest_avm_device_0,
