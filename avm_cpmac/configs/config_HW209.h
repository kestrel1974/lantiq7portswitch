#if !defined(__AVM_NET_CFG_HW209_)
#define __AVM_NET_CFG_HW209_
...
extern avmnet_module_t hw209_avmnet_mac_7port_2;
extern avmnet_module_t hw209_avmnet_phy_11G_0;

avmnet_device_t hw209_avmnet_avm_device_0 =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
   ...
   .mac_module        = &hw209_avmnet_mac_7port_2,
   .etht_stat         = {
                            DEFAULT_HW_STATS,
...
avmnet_device_t hw209_avmnet_avm_device_1 =
{
    .device            = NULL,
    .device_name       = "ptm_vr9",
...
avmnet_device_t *hw209_avmnet_avm_devices[] = {
    &hw209_avmnet_avm_device_0,
    &hw209_avmnet_avm_device_1
}; 

avmnet_module_t hw209_avmnet =
{
    .name               = "swi_vr9",
    ...
    .num_children       = 1,
    .children           = {
                            &hw209_avmnet_mac_7port_2
                          }
};



avmnet_module_t hw209_avmnet_mac_7port_2 =
{
    .name               = "mac_7port_0",
    ...
    .parent             = &hw209_avmnet,
    .num_children       = 1,
    .children           = { &hw209_avmnet_phy_11G_0 }
};

avmnet_module_t hw209_avmnet_phy_11G_0 =
{
    .name               = "phy_11G_0",
    .device_id          = &hw209_avmnet_avm_device_0,
    ...
    .parent             = &hw209_avmnet_mac_7port_2,
    .num_children       = 0,
    .children           = {}
};

#endif // __AVM_NET_CFG_HW209_
