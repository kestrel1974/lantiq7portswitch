#if !defined(__AVM_NET_CFG_ATHEROS_HW180)
#define __AVM_NET_CFG_ATHEROS_HW180
...
extern avmnet_module_t hw180_gmac1, hw180_ath_switch, hw180_module_eth0;

avmnet_device_t avmnet_hw180_avm_device_0 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
...
avmnet_device_t *avmnet_hw180_avm_devices[] = {
    &avmnet_hw180_avm_device_0
}; 

avmnet_module_t avmnet_HW180 ____cacheline_aligned =
{
    .name           = "athmac",
    ...
    .parent         = NULL,
    .num_children   = 1,
    .children       = { &hw180_gmac1 }
};

avmnet_module_t hw180_gmac1 ____cacheline_aligned =
{
    .name           = "gmac1",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    ...
    .parent         = &avmnet_HW180,
    .num_children   = 1,
    .children       = { &hw180_ath_switch },
};

avmnet_module_t hw180_ath_switch ____cacheline_aligned =
{
    .name           = "ar8326",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    ...
    .parent         = &hw180_gmac1,
    .num_children   = 1,
    .children       = { &hw180_module_eth0 }
};

avmnet_module_t hw180_module_eth0 ____cacheline_aligned =
{
    .name           = "ar803x0",
    .device_id      = &avmnet_hw180_avm_device_0,
