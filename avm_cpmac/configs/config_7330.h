#if !defined(__AVMNET_CFG_HW179_)
#define __AVMNET_CFG_HW179_
...
extern avmnet_module_t hw179_avmnet_mac_ar9_0;
extern avmnet_module_t hw179_avmnet_mac_ar9_1;

avmnet_device_t hw179_avmnet_avm_device_0 =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
   ...
   .mac_module        = &hw179_avmnet_mac_ar9_0,
};

avmnet_device_t hw179_avmnet_avm_device_1 =
{
   .device            = NULL,
   .device_name       = "eth1",
   .external_port_no  = 1,
   ...
   .device_setup_priv = avmnet_swi_ar9_setup_eth_priv,
   .flags		  	  = AVMNET_DEVICE_IFXPPA_ETH_LAN,
   .mac_module        = &hw179_avmnet_mac_ar9_1,
};


avmnet_device_t *hw179_avmnet_avm_devices[] = {
    &hw179_avmnet_avm_device_0,
    &hw179_avmnet_avm_device_1
}; 

avmnet_module_t hw179_avmnet =
{
    .name               = "swi_ar9",
    ...
    .parent             = NULL,
    .num_children       = 2,
    .children           = { &hw179_avmnet_mac_ar9_0,
                            &hw179_avmnet_mac_ar9_1,
                          }
};


extern avmnet_module_t hw179_avmnet_phy_ar803x_0;
extern avmnet_module_t hw179_avmnet_phy_ar803x_1;

avmnet_module_t hw179_avmnet_mac_ar9_0 =
{
    .name               = "mac_ar9_0",
    ...
    .parent             = &hw179_avmnet,
    .num_children       = 1,
    .children           = { &hw179_avmnet_phy_ar803x_0 }
};

avmnet_module_t hw179_avmnet_mac_ar9_1 =
{
    .name               = "mac_ar9_1",
    .type               = avmnet_modtype_mac,
    .priv               = NULL,
    ...
    .parent             = &hw179_avmnet,
    .num_children       = 1,
    .children           = { &hw179_avmnet_phy_ar803x_1 }
};

avmnet_module_t hw179_avmnet_phy_ar803x_0 =
{
    .name               = "phy_ar803x_0",
    .device_id          = &hw179_avmnet_avm_device_0,
    ...
    .parent             = &hw179_avmnet_mac_ar9_0,
    .num_children       = 0,
    .children           = {}
};

avmnet_module_t hw179_avmnet_phy_ar803x_1 =
{
    .name               = "phy_ar803x_1",
    .device_id          = &hw179_avmnet_avm_device_1,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
                            .flags = ( AVMNET_CONFIG_FLAG_MDIOADDR
