#if !defined(__AVM_NET_CFG_ATHEROS_195)
#define __AVM_NET_CFG_ATHEROS_195
...
extern avmnet_module_t hw195_gmac0;
extern avmnet_module_t hw195_gmac1;

avmnet_device_t avmnet_hw195_avm_device_0 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
...
avmnet_device_t avmnet_hw195_avm_device_1 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth3",
   .external_port_no  = 3,
...
avmnet_device_t avmnet_hw195_avm_device_2 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth2",
   .external_port_no  = 2,
...
avmnet_device_t avmnet_hw195_avm_device_3 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth1",
   .external_port_no  = 1,
...
avmnet_device_t *avmnet_hw195_avm_devices[] = {
    &avmnet_hw195_avm_device_0,
    &avmnet_hw195_avm_device_1,
    &avmnet_hw195_avm_device_2,
    &avmnet_hw195_avm_device_3
}; 

avmnet_module_t avmnet_HW195 ____cacheline_aligned =
{
    .name           = "athmac",
    ...
    .parent         = NULL,
    .num_children   = 2,
    .children       = { &hw195_gmac0, &hw195_gmac1 }
};

extern avmnet_module_t hw195_ath_switch, hw195_module_eth0, hw195_module_eth1, hw195_module_eth2, hw195_module_eth3;

avmnet_module_t hw195_gmac0 ____cacheline_aligned =
{
    .name           = "gmac0",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    ...
    .parent         = &avmnet_HW195,
    .num_children   = 1,
    .children       = { &hw195_module_eth0 },
};

avmnet_module_t hw195_gmac1 ____cacheline_aligned =
{
    .name           = "gmac1",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    ...
    .parent         = &avmnet_HW195,
    .num_children   = 1,
    .children       = { &hw195_ath_switch },
};

avmnet_module_t hw195_ath_switch ____cacheline_aligned =
{
    .name           = "ar8326",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    ...
    .parent         = &hw195_gmac1,
    .num_children   = 3,
    .children       = { &hw195_module_eth1, &hw195_module_eth2, &hw195_module_eth3 }
};

avmnet_module_t hw195_module_eth0 ____cacheline_aligned =
{
    .name           = "ar803x0",
    .device_id      = &avmnet_hw195_avm_device_0,
...
avmnet_module_t hw195_module_eth1 ____cacheline_aligned =
{
    .name           = "ar803x1",
    .device_id      = &avmnet_hw195_avm_device_1,
    .type           = avmnet_modtype_phy,
    .priv           = NULL,
    ...
    .parent         = &hw195_ath_switch,
    .num_children   = 0,
    .children       = {}
};

avmnet_module_t hw195_module_eth2 ____cacheline_aligned =
{
    .name           = "ar803x2",
    .device_id      = &avmnet_hw195_avm_device_2,
    .type           = avmnet_modtype_phy,
    .priv           = NULL,
...
avmnet_module_t hw195_module_eth3 ____cacheline_aligned =
{
    .name           = "ar803x3",
    .device_id      = &avmnet_hw195_avm_device_3,
    .type           = avmnet_modtype_phy,
    .priv           = NULL,
