#if !defined(__AVM_NET_CFG_hw231x_)
#define __AVM_NET_CFG_hw231x_
...
avmnet_device_t hw231x_avmnet_avm_device_0 =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
   ...
   /*--- .mac_module        = &hw231x_avmnet_mac_7port_1, ---*/
   .vlanID            = 1,
...
avmnet_device_t hw231x_avmnet_avm_device_1 =
{
   .device            = NULL,
   .device_name       = "eth1",
   .external_port_no  = 1,
...
avmnet_device_t hw231x_avmnet_avm_device_2 =
{
   .device            = NULL,
   .device_name       = "eth2",
   .external_port_no  = 2,
...
avmnet_device_t hw231x_avmnet_avm_device_3 =
{
   .device            = NULL,
   .device_name       = "eth3",
   .external_port_no  = 3,
...
avmnet_device_t *hw231x_avmnet_avm_devices[] = {
    &hw231x_avmnet_avm_device_0,
    &hw231x_avmnet_avm_device_1,
    &hw231x_avmnet_avm_device_2,
    &hw231x_avmnet_avm_device_3,
};

extern avmnet_module_t hw231x_avmnet_phy_ar803x_0;
extern avmnet_module_t hw231x_avmnet_phy_ar803x_1;
extern avmnet_module_t hw231x_avmnet_phy_ar803x_2;
extern avmnet_module_t hw231x_avmnet_phy_ar803x_3;
extern avmnet_module_t hw231x_ath_switch;

avmnet_module_t hw231x_avmnet =
{
    .name               = "vlan_master",
...
avmnet_module_t hw231x_ath_switch  =
{
    .name           = "ar8327",
//    .device_id      = &hw231x_avmnet_avm_device_6,   /*--- das Interface zum hw231x_avmnet_mac_7port_1 wird hier initialisiert ---*/
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    .initdata.swi   = { 
    ...
    .parent         = &hw231x_avmnet,
    .num_children   = 4,
    .children       = {
                        &hw231x_avmnet_phy_ar803x_0,
                        &hw231x_avmnet_phy_ar803x_1,
                        &hw231x_avmnet_phy_ar803x_2,
                        &hw231x_avmnet_phy_ar803x_3
                      }
};

avmnet_module_t hw231x_avmnet_phy_ar803x_0 =
{
    .name               = "phy_ar803x_0",
    .device_id          = &hw231x_avmnet_avm_device_0,
    ...
    .parent             = &hw231x_ath_switch,
    .num_children       = 0,
    .children           = {}
};

avmnet_module_t hw231x_avmnet_phy_ar803x_1 =
{
    .name               = "phy_ar803x_1",
    .device_id          = &hw231x_avmnet_avm_device_1,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
                            .flags = AVMNET_CONFIG_FLAG_MDIOADDR |
...
avmnet_module_t hw231x_avmnet_phy_ar803x_2 =
{
    .name               = "phy_ar803x_2",
    .device_id          = &hw231x_avmnet_avm_device_2,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
                            .flags = AVMNET_CONFIG_FLAG_MDIOADDR |
...
avmnet_module_t hw231x_avmnet_phy_ar803x_3 =
{
    .name               = "phy_ar803x_3",
    .device_id          = &hw231x_avmnet_avm_device_3,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
                            .flags = AVMNET_CONFIG_FLAG_MDIOADDR |
