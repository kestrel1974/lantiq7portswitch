#if !defined(__AVM_NET_CFG_ATHEROS_HW205_H_)
#define __AVM_NET_CFG_ATHEROS_HW205_H_
...
extern avmnet_module_t hw205_gmac0, hw205_module_eth0;

avmnet_device_t avmnet_hw205_avm_device_0 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
...
avmnet_device_t *avmnet_hw205_avm_devices[] = {
    &avmnet_hw205_avm_device_0,
}; 

avmnet_module_t avmnet_hw205 ____cacheline_aligned =
{
    .name           = "athmac",
    ...
    .parent         = NULL,
    .num_children   = 1,
    .children       = { &hw205_gmac0 }
};

avmnet_module_t hw205_gmac0 ____cacheline_aligned =
{
    .name           = "gmac0",
    .type           = avmnet_modtype_mac,
    .priv           = NULL,
    ...
    .parent         = &avmnet_hw205,
    .num_children   = 1,
    .children       = { &hw205_module_eth0 },
};

avmnet_module_t hw205_module_eth0 ____cacheline_aligned =
{
    .name           = "ar8033",
    .device_id      = &avmnet_hw205_avm_device_0,
