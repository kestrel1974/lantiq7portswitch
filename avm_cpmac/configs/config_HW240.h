#if !defined(__AVM_NET_CFG_ATHEROS_hw240_H_)
#define __AVM_NET_CFG_ATHEROS_hw240_H_
...
extern avmnet_module_t hw240_gmac1, hw240_module_eth0, hw240_ath_switch;

avmnet_device_t avmnet_hw240_avm_device_0 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
...
avmnet_device_t *avmnet_hw240_avm_devices[] = {
    &avmnet_hw240_avm_device_0,
};

avmnet_module_t avmnet_hw240 ____cacheline_aligned =
{
    .name           = "athmac",
    ...
    .parent         = NULL,
    .num_children   = 1,
    .children       = { &hw240_gmac1 }
};

avmnet_module_t hw240_gmac1 ____cacheline_aligned =
{
    .name           = "gmac1",
    .type           = avmnet_modtype_mac,
    .priv           = NULL,
    ...
    .parent         = &avmnet_hw240,
    .num_children   = 1,
    .children       = { &hw240_ath_switch },
};

avmnet_module_t hw240_ath_switch ____cacheline_aligned =
{
    .name           = "ar8326",
    ...
    .parent         = &hw240_gmac1,
    .num_children   = 1,
    .children       = { &hw240_module_eth0 }
};

avmnet_module_t hw240_module_eth0 ____cacheline_aligned =
{
    .name           = "ar80x0",
    .device_id      = &avmnet_hw240_avm_device_0,
