#if !defined(_AVM_NET_CFG_ATHEROS_HW190_)
#define _AVM_NET_CFG_ATHEROS_HW190_
...
extern avmnet_module_t HW190_gmac1;
extern avmnet_module_t HW190_ath_switch, HW190_module_plc, HW190_module_plc_phy;
extern avmnet_module_t HW190_module_eth1, HW190_module_eth2;

avmnet_device_t avmnet_hw190_avm_device_0 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "plc",
...
avmnet_device_t avmnet_hw190_avm_device_1 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
...
avmnet_device_t avmnet_hw190_avm_device_2 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth1",
   .external_port_no  = 1,
...
avmnet_device_t *avmnet_hw190_avm_devices[] = {
    &avmnet_hw190_avm_device_0,
    &avmnet_hw190_avm_device_1,
    &avmnet_hw190_avm_device_2,
}; 

avmnet_module_t avmnet_HW190 ____cacheline_aligned =
{
    .name           = "athmac",
    ...
    .parent         = NULL,
    .num_children   = 1,
    .children       = { &HW190_gmac1 }
};

avmnet_module_t HW190_gmac1 ____cacheline_aligned =
{
    .name           = "gmac1",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    .initdata.mac   = {  .flags = AVMNET_CONFIG_FLAG_BASEADDR | AVMNET_CONFIG_FLAG_IRQ | AVMNET_CONFIG_FLAG_SWITCHPORT,
    ...
    .parent         = &avmnet_HW190,
    .num_children   = 1,
    .children       = { &HW190_ath_switch },
};

avmnet_module_t HW190_ath_switch ____cacheline_aligned =
{
    .name           = "ar8326",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    ...
    .parent         = &HW190_gmac1,
    .num_children   = 3,
    .children       = { &HW190_module_plc_phy, &HW190_module_eth1, &HW190_module_eth2, NULL, NULL, NULL }
};

avmnet_module_t HW190_module_plc_phy ____cacheline_aligned =
{
    .name           = "ar803x0",
    .device_id      = &avmnet_hw190_avm_device_0,
    ...
    .parent         = &HW190_ath_switch,
    .num_children   = 1,
    .children       = {&HW190_module_plc}
};

avmnet_module_t HW190_module_plc ____cacheline_aligned =
{
    .name           = "plc",
    .device_id      = NULL,
    .type           = avmnet_modtype_phy,
    ...
    .parent         = &HW190_module_plc_phy,
    .num_children   = 0,
    .children       = {}
};

avmnet_module_t HW190_module_eth1 ____cacheline_aligned =
{
    .name           = "ar803x1",
    .device_id      = &avmnet_hw190_avm_device_1,
    .type           = avmnet_modtype_phy,
    .priv           = NULL,
    .initdata.phy   = {
                           .flags = ( AVMNET_CONFIG_FLAG_MDIOADDR
...
avmnet_module_t HW190_module_eth2 ____cacheline_aligned =
{
    .name           = "ar803x2",
    .device_id      = &avmnet_hw190_avm_device_2,
    .type           = avmnet_modtype_phy,
    .priv           = NULL,
    .initdata.phy   = {
                           .flags = ( AVMNET_CONFIG_FLAG_MDIOADDR
