#if !defined(__AVM_NET_CFG_HW202_)
#define __AVM_NET_CFG_HW202_
...
extern avmnet_module_t hw202_avmnet_mac_7port_2;
extern avmnet_module_t hw202_avmnet_mac_7port_4;

avmnet_device_t hw202_avmnet_avm_device_0 =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
   ...
   .mac_module        = &hw202_avmnet_mac_7port_4,
   .etht_stat         = {
                            DEFAULT_HW_STATS,
...
avmnet_device_t hw202_avmnet_avm_device_1 =
{
   .device            = NULL,
   .device_name       = "eth1",
   .external_port_no  = 1,
   ...
   .device_setup_priv = ifx_ppa_setup_priv,
   .flags		  	  = AVMNET_DEVICE_IFXPPA_ETH_LAN,
   .mac_module        = &hw202_avmnet_mac_7port_2,
   .etht_stat         = {
                            DEFAULT_HW_STATS,
                            DEFAULT_AVMNET_STATS,
                            .gather_hw_stats = create_7port_rmon_cnt,
...
avmnet_device_t hw202_avmnet_avm_device_2 =
{
   .device            = NULL,
   .device_name       = "eth2",
   .external_port_no  = 2,
   ...
   .device_setup_priv = ifx_ppa_setup_priv,
   .flags		  	  = AVMNET_DEVICE_IFXPPA_ETH_LAN,
   .mac_module        = &hw202_avmnet_mac_7port_0,
   .etht_stat         = {
                            DEFAULT_HW_STATS,
                            DEFAULT_AVMNET_STATS,
                            .gather_hw_stats = create_7port_rmon_cnt,
...
avmnet_device_t hw202_avmnet_avm_device_3 =
{
   .device            = NULL,
   .device_name       = "eth3",
   .external_port_no  = 3,
   ...
   .device_setup_priv = ifx_ppa_setup_priv,
   .flags		  	  = AVMNET_DEVICE_IFXPPA_ETH_LAN,
   .mac_module        = &hw202_avmnet_mac_7port_1,
   .etht_stat         = {
                            DEFAULT_HW_STATS,
                            DEFAULT_AVMNET_STATS,
                            .gather_hw_stats = create_7port_rmon_cnt,
...
avmnet_device_t hw202_avmnet_avm_device_4 =
{
   .device            = NULL,
   .device_name       = "ptm_vr9",
...
avmnet_device_t *hw202_avmnet_avm_devices[] = {
    &hw202_avmnet_avm_device_0,
    &hw202_avmnet_avm_device_1,
    &hw202_avmnet_avm_device_2,
    &hw202_avmnet_avm_device_3,
    &hw202_avmnet_avm_device_4,
}; 

avmnet_module_t hw202_avmnet =
{
    .name               = "swi_vr9",
    ...
    .parent             = NULL,
    .num_children       = 4,
    .children           = { &hw202_avmnet_mac_7port_0,
                            &hw202_avmnet_mac_7port_1,
                            &hw202_avmnet_mac_7port_2,
                            &hw202_avmnet_mac_7port_4
                          }
};


extern avmnet_module_t hw202_avmnet_phy_ar803x_0;
extern avmnet_module_t hw202_avmnet_phy_ar803x_1;
extern avmnet_module_t hw202_avmnet_phy_11G_0;
extern avmnet_module_t hw202_avmnet_phy_11G_1;

avmnet_module_t hw202_avmnet_mac_7port_0 =
{
    .name               = "mac_7port_0",
    ...
    .parent             = &hw202_avmnet,
    .num_children       = 1,
    .children           = { &hw202_avmnet_phy_ar803x_0 }
};

avmnet_module_t hw202_avmnet_mac_7port_1 =
{
    .name               = "mac_7port_1",
    .type               = avmnet_modtype_mac,
    .priv               = NULL,
    ...
    .parent             = &hw202_avmnet,
    .num_children       = 1,
    .children           = { &hw202_avmnet_phy_ar803x_1 }
};

avmnet_module_t hw202_avmnet_mac_7port_2 =
{
    .name               = "mac_7port_2",
    .type               = avmnet_modtype_mac,
    .priv               = NULL,
    ...
    .parent             = &hw202_avmnet,
    .num_children       = 1,
    .children           = { &hw202_avmnet_phy_11G_1 }
};

avmnet_module_t hw202_avmnet_mac_7port_4 =
{
    .name               = "mac_7port_4",
    .type               = avmnet_modtype_mac,
    .priv               = NULL,
    ...
    .parent             = &hw202_avmnet,
    .num_children       = 1,
    .children           = { &hw202_avmnet_phy_11G_0 }
};

avmnet_module_t hw202_avmnet_phy_ar803x_0 =
{
    .name               = "phy_ar803x_0",
    .device_id          = &hw202_avmnet_avm_device_2,
    ...
    .parent             = &hw202_avmnet_mac_7port_0,
    .num_children       = 0,
    .children           = {}
};

avmnet_module_t hw202_avmnet_phy_ar803x_1 =
{
    .name               = "phy_ar803x_1",
    .device_id          = &hw202_avmnet_avm_device_3,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
                            .flags = ( AVMNET_CONFIG_FLAG_MDIOADDR
    ...
    .parent             = &hw202_avmnet_mac_7port_1,
    .num_children       = 0,
    .children           = {}
};

avmnet_module_t hw202_avmnet_phy_11G_0 =
{
    .name               = "phy_11G_0",
    .device_id          = &hw202_avmnet_avm_device_0,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
...
//                                     | AVMNET_POLARITY_1000MBIT
    ...
    .parent             = &hw202_avmnet_mac_7port_4,
    .num_children       = 0,
    .children           = {}
};

avmnet_module_t hw202_avmnet_phy_11G_1 =
{
    .name               = "phy_11G_1",
    .device_id          = &hw202_avmnet_avm_device_1,
    .type               = avmnet_modtype_phy,
    .priv               = NULL,
    .initdata.phy       = {
                            .flags = (AVMNET_CONFIG_FLAG_PHY_GBIT
...
//                                     | AVMNET_POLARITY_1000MBIT
    ...
    .parent             = &hw202_avmnet_mac_7port_2,
    .num_children       = 0,
    .children           = {}
};


#endif // __AVM_NET_CFG_HW202_
