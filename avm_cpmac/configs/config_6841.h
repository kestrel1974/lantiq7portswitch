#if !defined(__AVM_NET_CFG_ATHEROS_)
#define __AVM_NET_CFG_ATHEROS_
...
extern avmnet_module_t gmac0, gmac1, ath_switch, module_eth0, module_eth1, module_eth2, module_eth3;

avmnet_device_t avmnet_hw184_avm_device_0 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
...
avmnet_device_t avmnet_hw184_avm_device_1 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth3",
   .external_port_no  = 3,
...
avmnet_device_t avmnet_hw184_avm_device_2 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth2",
   .external_port_no  = 2,
...
avmnet_device_t avmnet_hw184_avm_device_3 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth1",
   .external_port_no  = 1,
...
avmnet_device_t *avmnet_hw184_avm_devices[] = {
    &avmnet_hw184_avm_device_0,
    &avmnet_hw184_avm_device_1,
    &avmnet_hw184_avm_device_2,
    &avmnet_hw184_avm_device_3
}; 

avmnet_module_t avmnet_6841 ____cacheline_aligned =
{
    .name           = "athmac",
    ...
    .parent         = NULL,
    .num_children   = 2,
    .children       = { &gmac0, &gmac1 }
};

avmnet_module_t gmac0 ____cacheline_aligned =
{
    .name           = "gmac0",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    ...
    .parent         = &avmnet_6841,
    .num_children   = 1,
    .children       = { &module_eth0 },
};

avmnet_module_t gmac1 ____cacheline_aligned =
{
    .name           = "gmac1",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
...
avmnet_module_t ath_switch ____cacheline_aligned =
{
    .name           = "ar8326",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    ...
    .parent         = &gmac1,
    .num_children   = 3,
    .children       = { &module_eth1, &module_eth2, &module_eth3 }
};

avmnet_module_t module_eth0 ____cacheline_aligned =
{
    .name           = "ar803x0",
    .device_id      = &avmnet_hw184_avm_device_0,
...
avmnet_module_t module_eth1 ____cacheline_aligned =
{
    .name           = "ar803x1",
    .device_id      = &avmnet_hw184_avm_device_1,
    .type           = avmnet_modtype_phy,
    .priv           = NULL,
...
avmnet_module_t module_eth2 ____cacheline_aligned =
{
    .name           = "ar803x2",
    .device_id      = &avmnet_hw184_avm_device_2,
    .type           = avmnet_modtype_phy,
    .priv           = NULL,
...
avmnet_module_t module_eth3 ____cacheline_aligned =
{
    .name           = "ar803x3",
    .device_id      = &avmnet_hw184_avm_device_3,
    .type           = avmnet_modtype_phy,
    .priv           = NULL,
