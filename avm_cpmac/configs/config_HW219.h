#if !defined(__AVM_NET_CFG_ATHEROS_HW219)
#define __AVM_NET_CFG_ATHEROS_HW219
...
extern avmnet_module_t hw219_gmac0, hw219_gmac1, hw219_ath_switch, hw219_ath_switch_wan,
                       hw219_module_eth0, 
                       hw219_module_eth1, 
                       hw219_module_eth2, 
                       hw219_module_eth3, 
...
avmnet_device_t avmnet_hw219_avm_device_0 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
   ...
   .mac_module        = &hw219_gmac0,
   .vlanID            = 0, // GMAC0, SW MAC 0
   ...
   .etht_stat         = {
                            ...
                            .gather_hw_stats = create_athr_rmon_cnt,
                        },
};

avmnet_device_t avmnet_hw219_avm_device_1 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth4",
   .external_port_no  = 4,
...
avmnet_device_t avmnet_hw219_avm_device_2 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth3",
   .external_port_no  = 3,
...
avmnet_device_t avmnet_hw219_avm_device_3 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth2",
   .external_port_no  = 2,
   ...
   .etht_stat         = {
    ...
    /*------------------------------------------------------------------------------*\
     * ACHTUNG: Port 5 wird mit Port 0 getauscht, entsprechend muss auch die VlanID 
     * getauscht werden, der physikalische Port bleibt Port 5 (bei der Abfrage 
     * des Portstatus
    \*------------------------------------------------------------------------------*/
avmnet_device_t avmnet_hw219_avm_device_4 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth1",
   .external_port_no  = 1,
...
avmnet_device_t *avmnet_hw219_avm_devices[] = {
    &avmnet_hw219_avm_device_0,
    &avmnet_hw219_avm_device_1,
    &avmnet_hw219_avm_device_2,
    &avmnet_hw219_avm_device_3,
    &avmnet_hw219_avm_device_4
}; 

/*------------------------------------------------------------------------------------------*\
 * die Reihenfolge der Children darf hier nicht geändert werden, die Abtrennung des WAN-Ports 
 * funktioniert sonst nicht mehr
\*------------------------------------------------------------------------------------------*/
avmnet_module_t avmnet_HW219 ____cacheline_aligned =
{
    .name           = "athmac",
    ...
    .parent         = NULL,
    .num_children   = 2,
    .children       = { &hw219_gmac1, &hw219_gmac0 }
};

avmnet_module_t hw219_gmac0 ____cacheline_aligned =
{
    .name           = "gmac0",
    .type           = avmnet_modtype_mac,
    .priv           = NULL,
    ...
    .parent         = &avmnet_HW219,
    .num_children   = 1,
    .children       = { &hw219_ath_switch_wan },
};

avmnet_module_t hw219_gmac1 ____cacheline_aligned =
{
    .name           = "gmac1",
    .type           = avmnet_modtype_mac,
    .priv           = NULL,
    ...
    .parent         = &avmnet_HW219,
    .num_children   = 1,
    .children       = { &hw219_ath_switch },
};

avmnet_module_t hw219_ath_switch_wan ____cacheline_aligned =
{
    .name           = "ar8326_wan",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    .initdata       = { .swi = { .flags = AVMNET_CONFIG_FLAG_MAC_SUPPORT_FC_SYM}},

    .init           = avmnet_ar8326_init_wan,
    .setup          = avmnet_ar8326_setup_wan_HW219,
    ...
    .poll           = avmnet_ar8326_poll_intern_wan,
    ...
    .parent         = &hw219_gmac0,
    .num_children   = 1,
    .children       = { &hw219_module_eth0 },
};

avmnet_module_t hw219_ath_switch ____cacheline_aligned =
{
    .name           = "ar8326",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    ...
    .parent         = &hw219_gmac1,
    .num_children   = 4,
    .children       = { &hw219_module_eth1, &hw219_module_eth2, &hw219_module_eth3, &hw219_module_eth4 }
};

avmnet_module_t hw219_module_eth0 ____cacheline_aligned =
{
    .name           = "ar803x0",
    .device_id      = &avmnet_hw219_avm_device_0,
    ...
    .initdata.phy   = { .flags =   AVMNET_CONFIG_FLAG_INTERNAL 
     ...
     AR803X_STDFUNCS,
    .setup_special_hw = avmnet_4010_setup_phy,
    
    .ethtool_ops    = AR803X_ETHOPS,

    .parent         = &hw219_ath_switch_wan,
    .num_children   = 0,
    .children       = {}
};

avmnet_module_t hw219_module_eth1 ____cacheline_aligned =
{
    .name           = "ar803x4",
    .device_id      = &avmnet_hw219_avm_device_1,
    .type           = avmnet_modtype_phy,
    .priv           = NULL,
    .initdata.phy   = { .flags =   AVMNET_CONFIG_FLAG_INTERNAL 
                                 /*--- | AVMNET_CONFIG_FLAG_MDIOPOLLING ---*/
    ...
    .parent         = &hw219_ath_switch,
    .num_children   = 0,
    .children       = {}
};

avmnet_module_t hw219_module_eth2 ____cacheline_aligned =
{
    .name           = "ar803x3",
    .device_id      = &avmnet_hw219_avm_device_2,
    .type           = avmnet_modtype_phy,
    .priv           = NULL,
    .initdata.phy   = { .flags =   AVMNET_CONFIG_FLAG_INTERNAL 
                                 /*--- | AVMNET_CONFIG_FLAG_MDIOPOLLING ---*/
...
avmnet_module_t hw219_module_eth3 ____cacheline_aligned =
{
    .name           = "ar803x2",
    .device_id      = &avmnet_hw219_avm_device_3,
    .type           = avmnet_modtype_phy,
    .priv           = NULL,
    .initdata.phy   = { .flags =   AVMNET_CONFIG_FLAG_INTERNAL 
                                 /*--- | AVMNET_CONFIG_FLAG_MDIOPOLLING ---*/
...
avmnet_module_t hw219_module_eth4 ____cacheline_aligned =
{
    .name           = "ar803x1",
    .device_id      = &avmnet_hw219_avm_device_4,
    .type           = avmnet_modtype_phy,
    .priv           = NULL,
    .initdata.phy   = { .flags =   AVMNET_CONFIG_FLAG_INTERNAL 
                                 /*--- | AVMNET_CONFIG_FLAG_MDIOPOLLING ---*/
