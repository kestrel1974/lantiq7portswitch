#if !defined(__AVM_NET_CFG_ATHEROS_HW194)
#define __AVM_NET_CFG_ATHEROS_HW194
...
extern avmnet_module_t hw194_gmac1, hw194_ath_switch, hw194_module_eth0;

avmnet_device_t avmnet_hw194_avm_device_0 ____cacheline_aligned =
{
   .device            = NULL,
   .device_name       = "eth0",
   .external_port_no  = 0,
...
avmnet_device_t *avmnet_hw194_avm_devices[] = {
    &avmnet_hw194_avm_device_0
}; 

avmnet_module_t avmnet_HW194 ____cacheline_aligned =
{
    .name           = "athmac",
    ...
    .parent         = NULL,
    .num_children   = 1,
    .children       = { &hw194_gmac1 }
};

avmnet_module_t hw194_gmac1 ____cacheline_aligned =
{
    .name           = "gmac1",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    ...
    .parent         = &avmnet_HW194,
    .num_children   = 1,
    .children       = { &hw194_ath_switch },
};

avmnet_module_t hw194_ath_switch ____cacheline_aligned =
{
    .name           = "ar8326",
    .type           = avmnet_modtype_switch,
    .priv           = NULL,
    ...
    .parent         = &hw194_gmac1,
    .num_children   = 1,
    .children       = { &hw194_module_eth0 }
};

avmnet_module_t hw194_module_eth0 ____cacheline_aligned =
{
    .name           = "ar803x0",
    .device_id      = &avmnet_hw194_avm_device_0,
