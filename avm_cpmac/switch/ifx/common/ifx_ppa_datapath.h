...
#define SCORPION_RESET                  SIOCDEVPRIVATE + 15
...
extern int (*ifx_ppa_drv_avm_get_atm_qid_hook)(struct atm_vcc *vcc, unsigned int skb_priority);
extern int (*ifx_ppa_drv_avm_get_ptm_qid_hook)(unsigned int skb_priority);
extern int (*ifx_ppa_drv_avm_get_eth_qid_hook)(unsigned int mac_nr, unsigned int skb_priority);
#else
extern  int (*ifx_ppa_drv_get_dslwan_qid_with_vcc_hook)(PPA_VCC *, unsigned int);
...
extern  int (*ifx_ppa_drv_ppe_pwm_change_hook)(unsigned int , unsigned int );
extern int (*in_avm_ata_mode_hook)(void);
...
#define ifx_atm_dev_register(_name, _parent, _ops, _no, _flags) ((void)_parent, atm_dev_register(_name, _ops, _no, _flags))
#else
#define ifx_atm_dev_register(_name, _parent, _ops, _no, _flags) ((void)_parent, atm_dev_register(_name, _parent, _ops, _no, _flags))
#endif

#if LINUX_VERSION_CODE > KERNEL_VERSION(2, 6, 32)
static inline void *ipv6_addr_copy(void *dst, void *src){
	return memcpy(dst, src, 16);
}
#endif
