...
extern int ifx_ppa_drv_avm_get_atm_qid(struct atm_vcc *vcc, unsigned int skb_priority);
extern int ifx_ppa_drv_avm_get_ptm_qid(unsigned int skb_priority);
extern int ifx_ppa_drv_avm_get_eth_qid(unsigned int mac_nr, unsigned int skb_priority);
#else
...
extern uint32_t ifx_ppa_drv_activate_routing_entry(PPE_ROUTING_INFO *entry , uint32_t flag);
