...
IFX_FLOW_PCE_MICROCODE pce_mc_max_ifx_tag_m = {
    ...
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 40 , OUT_ETHTYP , 1 , INSTR , FLAG_NO , 0),
    IFX_FLOW_PCE_MC_M(0x0600 , 0x0600 , 40 , OUT_ETHTYP , 1 , INSTR , FLAG_NO , 0),
    ...
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 43 , OUT_NONE , 0 , INSTR , FLAG_NO , 0),
    IFX_FLOW_PCE_MC_M(0x0300 , 0xFF00 , 43 , OUT_NONE , 0 , INSTR , FLAG_SNAP , 0),
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 43 , OUT_NONE , 0 , INSTR , FLAG_NO , 0),
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 43 , OUT_DIP7 , 3 , INSTR , FLAG_NO , 0),
    ...
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 40 , OUT_NONE , 0 , INSTR , FLAG_NO , 0),
    ...
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 40 , OUT_NONE , 0 , LENACCU , FLAG_NO , 0),
    IFX_FLOW_PCE_MC_M(0x1100 , 0xFF00 , 39 , OUT_PROT , 1 , INSTR , FLAG_NO , 0),
    IFX_FLOW_PCE_MC_M(0x0600 , 0xFF00 , 39 , OUT_PROT , 1 , INSTR , FLAG_NO , 0),
    ...
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 39 , OUT_PROT , 1 , INSTR , FLAG_NO , 0),
    IFX_FLOW_PCE_MC_M(0x0000 , 0x00E0 , 35 , OUT_NONE , 0 , INSTR , FLAG_NO , 0),
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 40 , OUT_NONE , 0 , INSTR , FLAG_NO , 0), // HDR_EXT_LEN FIX
    ...
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 40 , OUT_PROT , 1 , IPV6 , FLAG_NO , 0),
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 40 , OUT_SIP0 , 16 , INSTR , FLAG_NO , 0),
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 41 , OUT_APP0 , 4 , INSTR , FLAG_IGMP , 0),
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 42 , OUT_NONE , 2 , INSTR , FLAG_NO , 0),
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 43 , OUT_APP0 , 2 , INSTR , FLAG_NO , 0), //AVM COPY TCP FLAGS
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 43 , OUT_NONE , 0 , INSTR , FLAG_END , 0),
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 43 , OUT_NONE , 0 , INSTR , FLAG_END , 0),
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 43 , OUT_NONE , 0 , INSTR , FLAG_END , 0),
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 43 , OUT_NONE , 0 , INSTR , FLAG_END , 0),
    IFX_FLOW_PCE_MC_M(0x0000 , 0x0000 , 43 , OUT_NONE , 0 , INSTR , FLAG_END , 0),
...
IFX_int32_t ifx_pce_action_delete(IFX_PCE_t *pHandle, IFX_uint32_t index)
{
	...
	if (pcetable.valid == IFX_TRUE) {
		if ( ( (pcetable.val[0] >> 1) & 0x1 ) == IFX_TRUE) {
			IFX_uint32_t idx =(pcetable.val[2] & 0x3F) ;
			if (pHandle->pce_sub_tbl.vlan_act_tbl_cnt[idx] > 0)
				pHandle->pce_sub_tbl.vlan_act_tbl_cnt[idx]--;
		}
	}
	pcetable.valid = 0;
	ifx_ethsw_xwayflow_pce_table_write(pDevCtx, &pcetable);
...
IFX_int32_t ifx_pce_tm_print_tables(IFX_PCE_HANDLE_t *pTmHandle)
{
   ...
   table_printed = 0;
    for (i = 0; i < IFX_PCE_PTCL_TBL_SIZE ; i++) {
