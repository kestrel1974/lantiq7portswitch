...
static uint16_t g_ipv6_ip_counter[MAX_IPV6_IP_ENTRIES * 2] = {0};
 ...
 */
uint32_t get_routing_entry_bytes(uint32_t entry, uint32_t reset_flag __attribute__((unused)))
{
    unsigned long ppe_lock_flags;
    PPE_LOCK *p_lock;
    volatile struct rout_forward_action_tbl *paction;
...
/*!
    ...
    \return The return value can be any one of the following:  \n
               ...
               - IFX_FAILURE on error \n
*/
int32_t set_ctrl_qos_rate( uint32_t portid, uint32_t enable, uint32_t flag __attribute__((unused)))
{
...
/*!
    ...
    \return The return value can be any one of the following:  \n
               ...
               - IFX_FAILURE on error \n
*/
int32_t get_ctrl_qos_rate( uint32_t portid, uint32_t *enable, uint32_t flag __attribute__((unused)))
{
    if( set_qos_port_id() != IFX_SUCCESS )  return IFX_FAILURE; //QOS Note: Different condition with different mode/platfrom
...
/*!
    ...
    \return The return value can be any one of the following:  \n
               ...
               - IFX_FAILURE on error \n
*/
int32_t get_ctrl_qos_wfq( uint32_t portid, uint32_t *enable, uint32_t flag __attribute__((unused)))
{
    if( set_qos_port_id() != IFX_SUCCESS ) return IFX_FAILURE; //QOS Note: Different condition with different mode/platfrom
...
int32_t ifx_ppa_drv_get_mib(PPA_DSL_QUEUE_MIB *buffer, uint32_t flag __attribute__((unused)))
{
    unsigned int i;
