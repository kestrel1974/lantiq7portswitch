 ...
 *
 *  CCB: Was ist mit dem Range: __sb_addr[0x6000; 0x6FFF] ?!
 *
 */
#define SB_BUFFER(__sb_addr)            ((volatile unsigned int *)( \
        (__sb_addr <= 0x1FFF)                            ? PPE_REG_ADDR(__sb_addr) :          \
        ...
        ((__sb_addr >= 0x8000) && (__sb_addr <= 0xFFFF)) ? SB_RAM6_ADDR(__sb_addr - 0x8000) : \
         (__sb_addr >  0xFFFF)                           ? 0 : \
                PPE_REG_ADDR(__sb_addr) )) // ccb: this case should never happen it is just for our lovely Klockwork

#if 0
#define SB_BUFFER(__sb_addr)            ((volatile unsigned int *)( (__sb_addr <= 0x1FFF) ? PPE_REG_ADDR(__sb_addr) :           \
                                                                   ((__sb_addr >= 0x2000) && (__sb_addr <= 0x2FFF)) ? SB_RAM0_ADDR(__sb_addr - 0x2000) :  \
                                                                   ((__sb_addr >= 0x3000) && (__sb_addr <= 0x3FFF)) ? SB_RAM1_ADDR(__sb_addr - 0x3000) :  \
                                                                   ((__sb_addr >= 0x4000) && (__sb_addr <= 0x4FFF)) ? SB_RAM2_ADDR(__sb_addr - 0x4000) :  \
                                                                   ((__sb_addr >= 0x5000) && (__sb_addr <= 0x5FFF)) ? SB_RAM3_ADDR(__sb_addr - 0x5000) :  \
                                                                   ((__sb_addr >= 0x7000) && (__sb_addr <= 0x7FFF)) ? PPE_REG_ADDR(__sb_addr - 0x7000) :  \
                                                                   ((__sb_addr >= 0x8000) && (__sb_addr <= 0xFFFF)) ? SB_RAM6_ADDR(__sb_addr - 0x8000) : 0 ))
#endif
...
#define WRX_QUEUES  16
#define WTX_QUEUES  15
...
#define SESSION_MIB_COUNT_LEN 24
  struct rout_forward_action_tbl {
    ...
    unsigned int    bytes               :SESSION_MIB_COUNT_LEN;
  };
...
#else
#error we have just support for BIG ENDIAN
#endif
