...
#define MAX_COLLISION_ROUTING_ENTRIES           (g_ipv6_acc_en ? 32U : 64U)
#define MAX_HASH_BLOCK                          8U
#define MAX_ROUTING_ENTRIES_PER_HASH_BLOCK      16U
 ...
 */
#define SB_BUFFER(__sb_addr)    ( (volatile u32 *)  (( (__sb_addr) <= 0x0FFF )   ?  PPE_REG_ADDR(__sb_addr) :                           \
