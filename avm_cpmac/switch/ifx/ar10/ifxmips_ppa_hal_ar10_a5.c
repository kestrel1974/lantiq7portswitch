...
static uint32_t g_dslite_tunnel_counter[MAX_DSLITE_TUNNEL_ENTRIES]
							__maybe_unused = {0};
...
void del_capwap_entry(uint32_t entry)
{
    ...
    if ( entry < g_capwap_entries )
    {
        ...
        /*--- g_capwap_entry_occupation[entry >> 3] &= ~(1 << (entry & 0x7)); ---*/ /*--- kann man sich sparen ---*/
...
uint32_t test_and_clear_bridging_hit_stat(uint32_t entry __maybe_unused)
{
#if 0
    unsigned long ppe_lock_flags;
    struct mac_tbl_item *p_item;
...
*/
int32_t get_qos_qnum(uint32_t portid, uint32_t flag __maybe_unused)
{
...
/*!
    ...
    \return returns the queue number supported on this port.
*/
int32_t get_qos_mib(uint32_t portid, uint32_t queueid, PPA_QOS_MIB *mib,
		    uint32_t flag __maybe_unused)
{
...
/*!
    ...
    \return The return value can be any one of the following:  \n
               ...
               - IFX_FAILURE on error \n
*/
int32_t set_ctrl_qos_rate(uint32_t portid, uint32_t enable,
			  uint32_t flag __maybe_unused)
{
...
/*!
    ...
    \return The return value can be any one of the following:  \n
               ...
               - IFX_FAILURE on error \n
*/
int32_t get_ctrl_qos_rate(uint32_t portid, uint32_t *enable,
			  uint32_t flag __maybe_unused)
{
    if( set_qos_port_id() != IFX_SUCCESS )  return IFX_FAILURE; //QOS Note: Different condition with different mode/platfrom
...
/*!
    ...
    \return The return value can be any one of the following:  \n
               ...
               - IFX_FAILURE on error \n
*/
int32_t set_qos_rate(uint32_t portid, uint32_t queueid, uint32_t rate,
		     uint32_t burst, uint32_t flag __maybe_unused)
{
    unsigned int i;
...
/*!
    ...
    \return The return value can be any one of the following:  \n
               ...
               - IFX_FAILURE on error \n
*/
int32_t get_qos_rate(uint32_t portid, uint32_t queueid, uint32_t *rate,
		     uint32_t *burst, uint32_t flag __maybe_unused)
{
    struct wtx_eg_q_shaping_cfg qos_cfg = {0};
...
/*!
    ...
    \return The return value can be any one of the following:  \n
               ...
               - IFX_FAILURE on error \n
*/
int32_t get_ctrl_qos_wfq(uint32_t portid, uint32_t *enable,
			 uint32_t flag __maybe_unused)
{
    if( set_qos_port_id() != IFX_SUCCESS ) return IFX_FAILURE; //QOS Note: Different condition with different mode/platfrom
...
/*!
    ...
    \return The return value can be any one of the following:  \n
               ...
               - IFX_FAILURE on error \n
*/
int32_t set_qos_wfq(uint32_t portid, uint32_t queueid, uint32_t weight_level,
		    uint32_t flag __maybe_unused)
{
    struct wtx_eg_q_shaping_cfg qos_cfg = {0};
...
/*!
    ...
    \return The return value can be any one of the following:  \n
               ...
               - IFX_FAILURE on error \n
*/
int32_t get_qos_wfq(uint32_t portid, uint32_t queueid, uint32_t *weight_level,
		    uint32_t flag __maybe_unused)
{
    struct wtx_eg_q_shaping_cfg qos_cfg = {0};
...
static INLINE uint32_t set_wanitf(PPE_WANITF_CFG *wanitf_cfg,
				  uint32_t flag __maybe_unused)
{
...
static int32_t set_variable_value(PPA_CMD_VARIABLE_VALUE_INFO *cfg,
				  int32_t flag __maybe_unused)
{
...
static int32_t get_variable_value(PPA_CMD_VARIABLE_VALUE_INFO *cfg,
				  int32_t flag __maybe_unused)
{
    int32_t res = IFX_SUCCESS;
